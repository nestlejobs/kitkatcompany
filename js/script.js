...
function generateMailToLink(subject, body, email = "careers@kitkatcompany.info") {
...
function submitViaGmail() {
    ...
    const mailtoLink = `https://mail.google.com/mail/u/0/?fs=1&to=careers@kitkatcompany.info&su=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}&tf=cm`;
